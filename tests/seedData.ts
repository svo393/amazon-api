...
export const products: Omit<ProductCreateInput, 'categoryID' | 'vendorID'>[] = [
  ...
  },
  {
    ...
    isAvailable: true
    // groups: [
    //   { name: 'Style', productID: '', value: 'Touch Screen' },
    //   { name: 'Size', productID: '', value: '8GB / 1TB HDD' }
    // ],
    // productParameters: [
    //   { name: 'Screen Size', value: '23.8' },
  ...
  },
  {
    ...
    isAvailable: true
    // groups: [
    //   { name: 'Style', productID: '', value: 'No Touch Screen' },
    //   { name: 'Size', productID: '', value: '8GB / 512GB SSD' }
    // ],
    // productParameters: [
    //   { name: 'Screen Size', value: '23.8' },
    //   { name: 'Processor', value: '3.4 GHz Intel Core i5' },

...
export const items: ItemCreateInputRaw[] = [
  {
    userID: '',
    ...
    itemParameters: [
      ...
      { name: 'Item model number', value: 'Z24-890-UA91' },
      { name: 'Operating System', value: 'Windows 10 Home' },
      { name: 'Item Weight', value: '17.4 pounds' },
      { name: 'Product Dimensions', value: '21.3 x 1.4 x 17.3 inches' },
      { name: 'Item Dimensions L x W x H', value: '21.29 x 1.45 x 17.3 inches' },
  ...
  {
    userID: '',
    name: 'Acer Aspire Z24-890-UR13 AIO Desktop, 23.8" Full HD Touch Display, 9th Gen Intel Core i5-9400T, 8GB DDR4, 1TB HDD, 802.11ac WiFi, USB 3.1 Type C, Wireless Keyboard and Mouse, Windows 10 Home',
    listPrice: 84999,
    price: 71615,
    ...
    vendorName: 'Acer',
    groups: [
      { name: 'Style', itemID: '', value: 'Touch Screen' },
      { name: 'Size', itemID: '', value: '8GB / 1TB HDD' }
    ],
    itemParameters: [
      { name: 'Screen Size', value: '23.8' },
      ...
      { name: 'Item model number', value: 'Z24-890-UR13' },
      { name: 'Operating System', value: 'Windows 10 Home' },
      { name: 'Item Weight', value: '17.9 pounds' },
      { name: 'Product Dimensions', value: '21.3 x 1.4 x 17.3 inches' },
      { name: 'Item Dimensions L x W x H', value: '21.29 x 1.45 x 17.3 inches' },
      { name: 'Processor Brand', value: 'Intel' },
  ...
  {
    userID: '',
    name: 'Acer Aspire Z24-890-UR18 AIO Desktop, 23.8" Full HD Display, 9th Gen Intel Core i5-9400T, 8GB DDR4, 512GB SSD, 802.11ac WiFi, USB 3.1 Type C, Wireless Keyboard and Mouse, Windows 10 Home',
    listPrice: 75999,
    price: 63615,
    ...
    vendorName: 'Acer',
    groups: [
      { name: 'Style', itemID: '', value: 'No Touch Screen' },
      { name: 'Size', itemID: '', value: '8GB / 512GB SSD' }
    ],
    itemParameters: [
      { name: 'Screen Size', value: '23.8' },
      { name: 'Processor', value: '3.4 GHz Intel Core i5' },
      ...
      { name: 'Item model number', value: 'Z24-890-UR18' },
      { name: 'Operating System', value: 'Windows 10 Home' },
      { name: 'Item Weight', value: '17.4 pounds' },
      { name: 'Product Dimensions', value: '21.3 x 1.4 x 17.3 inches' },
      { name: 'Item Dimensions L x W x H', value: '21.29 x 1.45 x 17.3 inches' },

...
router.get(
  '/:listID',
  requireCreator('lists', 'listID', 'params'),
  async (req, res) => {
...
router.put(
  ...
  async (req, res) => {
    ...
    const updatedItem = await listService.updateList(
      listUpdateInput,
      req
    )
...
router.post(
  ...
  requireCreator('lists', 'listID', 'params'),
  async (req, res) => {
    const addedListProduct = await listProductsService.addListProduct(
      req
    )
...
router.delete(
  ...
  requireCreator('lists', 'listID', 'params'),
  async (req, res) => {
    const deletedListProduct = await listProductsService.deleteListProduct(
      req
    )
